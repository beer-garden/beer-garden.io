...
link:https://www.crummy.com/software/BeautifulSoup/[BeautifulSoup, title=BeautifulSoup].
...
image:webscraper-response-formatted.png[Web Scraper Formatted Results, title=Web Scraper Formatted Results]
...
image:webscraper-response-raw.png[Web Scraper Raw Results, title=Web Scraper Raw Results]
