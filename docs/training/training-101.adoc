...
This is a guided plugin development that are intended to be deployed against an active Beer Garden
instance. This only focuses on the developing remote plugins.

link:../local-vs-remote.adoc[Local vs Remote]::
If you are interested in the difference between Remote and Local plugins, check out our guide
